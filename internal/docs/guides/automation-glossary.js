...
import { Heading1, Heading2 } from '../docs-components'
  ...
  render() {
    return (
      <div>
        ...
        <Paragraph>
          The goal of the automation glossary is to help you to write automation tests when writing
          them with tools like Webdriver.io or Chrome Puppeteer by providing{' '}
