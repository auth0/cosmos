    ...
    return (
      <div>
        ...
        <Container>
          ...
          <Text>
            Every line of code should appear to be written by a single person, no matter the number
            of contributors.
          </Text>

          <Text>
            This set of rules generate some constraints and conventions. If you run into instances
            where a convention isn’t obvious or a solution could be handled in a few different ways,
            contact the Cosmos community, have a conversation about how to handle it and update
            these guidelines when needed.
          </Text>
          ...
          <Text>
            Layouts are containers that allow for organizing and grouping its immediate children on
            the page.
          </Text>
          <List>
          ...
          <List>
            ...
            <ListItem>
              Elements inside a component never use top margins. The first element touches the top
              of its component and the last element's margin is cleared.
            </ListItem>
            <ListItem>
              Components should include semantic markup and necessary Aria tags implemented
              following WAI-ARIA AA standards and meet{' '}
          ...
          <Text>
            Each component can subscribe to a set of modifiers or props. For example, a button can
            take different backgrounds.
          </Text>
          <Text>
          ...
          <Text>
            Cosmos components follow the Atomic design principles. Please make sure to read and
            understand the Atomic design philosophy as well as the Atomic design terminology and
          ...
          <Text>
            The modifiers for each components comes in the form of props that a component can
            subscribe to.
          </Text>
...
<Card>
  ...
  <Card.Footer></Card.Footer>
          ...
          <Text>
            Cosmos follows a two-layer theming system where global tokens always inform component
            token. Each one of those layers follows a set of very specific rules.
          </Text>

          <Heading3>Global tokens</Heading3>
          <Text>
            The main reason to have global tokens is to maintain consistency. They adhere to the
            following rules:
          </Text>
          ...
          <List>
            ...
            <ListItem>
              a <Code>Modifier</Code> is something like <Code>Small</Code>, or <Code>Large</Code>,
              or a state like <Code>Hover</Code>, or <Code>Expanded</Code>;
            </ListItem>
            <ListItem>
              They are concepts, never tied to an element or component. This is incorrect:{' '}
              <Code>Global.FontSize.H1</Code>, this is correct:{' '}
              <Code>Global.FontSize.ExtraLarge</Code>.
            </ListItem>
          </List>
          ...
          <Text>
            This setup allows for consistency across components, it generates a common language
            between designers and developers, and it gives granular control to authors implementing
            the system.
          </Text>

          <Heading4>Comment all magic values</Heading4>
          <Text>
            If a situation arises where a value needs entering into the style sheets that aren't
            already defined in the global tokens this should serve as a red flag to you.
          </Text>

          <Text>
            In the case where a 'magic' value needs entering, ensure to create a component token
            with the magic number for value, and a comment must be added on the line above to
