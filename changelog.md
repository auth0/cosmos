...
## 0.38.1 [February 12, 2021]

### Changes

- Tooltip: fix unexpected truncating and breaking of tip content in Safari [#1736]
## 0.38.0 [January 14, 2021]

### Changes

- Avatar: fix infinite loop when `image` prop missing and gravatar fails [#1733]
- update Input actions to have align-items: center [#1731]
...
- Form.Field: Add `required` prop. [#1695]

## 0.33.0 [January 9th, 2020]

### Changes

- Select: Add `onFocus` and `onBlur` props. [#1693]
- TextArea: Add `name`, `onFocus` and `onBlur` props. [#1692]

### Internal

- Update dependencies. [#1691]

## 0.32.1 [January 6th, 2020]

### Fixes

- Add `lodash.isempty` missing dependency in the published package. [#1689]
...
- Alert: Remove `type` prop in favor of `appearance`. [#1655]
- Text: Always return a `<span>` element as root. [#1653]

### Internal

- Security: Updated `lodash` to 4.17.14. [#1647]
...
- Update `webpack-dev-server` to the latest version. [#1617][#1619]
...
- TextArea: add `value` and `defaultValie`, `spellCheck` native input props. [#1590]
