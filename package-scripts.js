...
module.exports = {
  scripts: {
    ...
    test: {
      ...
      chromaticci: {
        script:
          'if [[ $TRAVIS_EVENT_TYPE != "pull_request" || "$TRAVIS_PULL_REQUEST_SLUG" != "$TRAVIS_REPO_SLUG" ]]; then chromatic test --storybook-addon --script-name=sandbox --exit-zero-on-changes; fi;',
