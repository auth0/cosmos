const colors = {
  ...
  button: {
    ...
    secondaryBackgroundHover: '#F1F1F1',
    secondaryBackgroundFocus: '#A8A8A8',
    secondaryText: '#333',
    secondaryIcon: '#333',
    secondaryBorder: '#d0d2d3',
    secondaryBorderHover: '#A8A8A8',
    secondaryBorderFocus: '#333',
    ctaBackground: '#eb5424',
    ctaBackgroundHover: '#ca3f12',
    ctaBackgroundFocus: '#ca3f12',
    ctaText: '#FFF',
    ctaIcon: '#FFF',
    ctaBorder: '#eb5424',
    ctaBorderHover: '#ca3f12',
    ctaBorderFocus: '#ca3f12',
