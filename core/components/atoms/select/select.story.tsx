...
storiesOf("Select", module).add("multiple tags", () => (
  <ExampleForSelect title="Select: stressed multiple tags">
    <Select
      multiple
      value={[1, 2, 3]}
      options={[{ text: "Applications", value: 1 }, { text: "Connections", value: 2 }, { text: "Logs", value: 3 }]}
    />
  </ExampleForSelect>
));
...
storiesOf("Select", module).add("disabled with placeholder", () => (
  <ExampleForSelect title="Select: disabled with placeholder">
    <Select
      defaultMenuOpen
      disabled={true}
      placeholder="Select from the enabled options"
