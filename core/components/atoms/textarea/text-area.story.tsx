...
storiesOf('TextArea', module).add('with actions as shape', () => (
...
storiesOf('TextArea', module).add('with actions as buttons', () => (
...
storiesOf('TextArea', module).add('with a copy action', () => (
