...
import { Paragraph, Link, Code } from '../../'
...
storiesOf('Paragraph', module).add('with styles', () => (
  <Example title="Paragraph with styles">
    <Paragraph>
      Now that you have an <Link href="https://auth0.com">account</Link>, we need to know about your
      ...
      <Link href="https://auth0.com">OAuth 2.0</Link> does).
    </Paragraph>
    ...
    <Paragraph>
      ...
      <Link href="https://auth0.com">Auth0 APIs</Link>.
    </Paragraph>
    ...
    <Paragraph>
      ...
      <Link href="https://auth0.com">impersonate your application</Link> and access protected
