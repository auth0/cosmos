...
import { Button, TextInput, Tooltip } from '../../'
...
storiesOf('TextInput', module).add('with actions as shape', () => (
...
class InteractiveExample extends React.Component<{}, { working: boolean }> {
  constructor(props) {
    super(props)
...
storiesOf('TextInput', module).add('interactive example', () => (
  <Example title="with actions as buttons">
    <InteractiveExample />
  </Example>
))
