...
`AvatarBlock` builds on [Avatar](/docs/atoms/avatar), allowing you to display a title and subtitle and link option along with the image.
...
You can use `AvatarBlock` inside `ResourceList` to complement and link their apps.
