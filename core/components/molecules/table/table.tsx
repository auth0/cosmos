...
class Table extends React.Component<ITableProps, ITableState> {
  ...
  public inferColumnsFromChildren(children) {
    return React.Children.toArray(children).map((element) => {
      return React.isValidElement(element) ? element.props : null;
    });
  }
    ...
    return (
      <Table.Container>
        <Table.Element {...Automation("table")} {...this.props} rows={rows}>
          <Table.Header columns={columns} sortingColumn={sortingColumn} sortDirection={sortDirection} onSort={onSort} />
